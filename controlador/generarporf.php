<?php
$fecha=$_POST['fechajornada'];
require_once('../class.ezpdf.php');
require_once ('../modelo/conex.php');
$funcion->conectar();
	$sql="SELECT jornadas.numjornada, jornadas.fechajornada, jornadas.direccion, jornadas.tlfcontacto, jornadas.descripcion, parroquia.nombreparro FROM jornadas INNER JOIN parroquia ON jornadas.numparroquia=parroquia.numparroquia WHERE jornadas.fechajornada='".$fecha."'";
